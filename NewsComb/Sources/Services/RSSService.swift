...
struct RSSService {
    ...
    @concurrent
    private func fetchFeed(source: RSSSource, extractService: FeedbinExtractService) async -> FetchResult {
    ...
    private func processFeed(_ feed: Feed, source: RSSSource, extractService: FeedbinExtractService) async throws -> Int {
        var itemCount = 0
    ...
    private func processRSSItem(_ item: RSSFeedItem, source: RSSSource, extractService: FeedbinExtractService) async throws {
